...
export const nfts: NFTCreateData[] = [
  {
    contractAddress: "0xFa4274E3C42E4072605963A9bd6bCa0d3c506d5F",
    symbol: "ETHGifts",
    nftAppType: "DELIVERY",
    nftDeliveryData: {
      create: {
        merkleUrl:
          "https://raw.githubusercontent.com/EthereumCN-eth/merkle-drop-data-chunks/main/chunks/0x5f40845f3514d446160913b22173f956cdeee6a15d241dc0c26f3d5709e54c00.json",
        tokenType: "ERC721",
        contractAddress: "0xFa4274E3C42E4072605963A9bd6bCa0d3c506d5F",
      },
    },
    ...
    galleryItemBase: {
      create: {
        ...
        infoDetail: {
          ...
          subTitle: "The Road to PoSnd Weeth",
          dataSection: [
            {
              heading: "活动介绍",
              subHeading: "Event Introduction",
      ...
      create: {
        ...
        infoDetail: {
          deliveryText: {
            ...
            noClaimedText: `🙁你错过了 2021 年 2 月 11 日~14 日ECN 在 Decentraland 举办的“2021牛年新春活动”，但未来 ECN 还有很多活动等待你的参与哦🥰`,
            endedNoText: `🙁你错过了 2021 年 2 月 11 日~14 日ECN 在 Decentraland 举办的“2021牛年新春活动”，但未来 ECN 还有很多活动等待你的参与哦🥰`,
          },
          eventDescription: "",
          ...
          dataSection: [
            {
              ...
              type: "html",
              data: [
                "2021 年 2 月 11 日~14 日，ECN 在 Decentraland 的龙城举行了牛年新春活动，主题为“当以太坊遇见虚拟世界和非遗传统文化”。此次活动内容丰富，奖品特别。ECN 邀请了 AI 和区块链艺术家宋婷 (Twitter@song11ting) 制作此次活动的奖品，包括 Non Fungible Indigo 系列的 0 号作品和 1 号作品，以及以以太坊为主题的扎染和蜡染作品，其中的创作理念是，“扎染”是中国非物质文化遗产，古称扎缬、绞缬、夹缬和染缬。“扎”的过程如同创建私钥，“染”的过程如同基于私钥创建公钥。艺术家宋婷也想以区块链技术守护古典技艺瑰宝、传递可持续发展理念。",
              ],
            },
            {
              heading: "NFT制作花絮",
      ...
      create: {
        ...
        infoDetail: {
          deliveryText: {
            ...
            noClaimedText: `🙁你错过了 2021 年 10 月 ECN 携 togETHer 的社区小伙伴在上海举办的线下以太坊社区 Meetup，但未来 ECN 还有很多活动等待你的参与哦🥰`,
            endedNoText: `🙁你错过了 2021 年 10 月 ECN 携 togETHer 的社区小伙伴在上海举办的线下以太坊社区 Meetup，但未来 ECN 还有很多活动等待你的参与哦🥰`,
          },
          eventDescription: "",
          title: "2021 上海以太坊 Meetup",
          subTitle: "2021 TogETHer Ethereum Meetup",
          dataSection: [
            {
              heading: "活动介绍",
              subHeading: "Event Introduction",
          ...
          dataSection: [
            {
              ...
              data: [
                ...
                "为了鼓励并认证社区成员的贡献，并丰富社区成员的 web3 数据，ECN 将推出志愿翻译的链上 SBT。",
              ],
            },
          ],
        } as Prisma.InputJsonValue,
