...
const fAQData = [
  {
    ...
    answer: (
      <Text textAlign="start">
        ...
        时代的凭证范式——使用密码学签名、携带任意信息的防篡改数据对象、每个实例都是唯一的、围绕数据对象本身的来源提供保证、由受信任的机构发行或铸造、但不为任何中心化机构或平台所有。EthGifts
        使用的 web3 数字凭证类型包括 NFT、SBT、POAP 和 Verifiable
        Credentials。`}
        <ChakraNextLink
          target="_blank"
          textDecoration="underline"
          href="https://www.ethereum.cn/ethgifts-docs/"
        >
          更多↗
        </ChakraNextLink>
      </Text>
...

  {
    ...
    answer: (
      <Text textAlign="start">
        ...
        ”的区块链账户或钱包里。在具体实现上，目前还没有社区广泛认可的规范，在
        EthGifts 上发行的 SBT
  ...
  {
    question: "是什么Verifiable Credential？",
    answer: (
      <Text textAlign="start">
        ...
        默认情况下是存储在链下的，这就允许用户根据需要有选择地只与互联网上的相关方分享凭证数据，赋予了用户对个人数据的自主权和隐私权。EthGifts
        发行的 VC
  ...
  },
  {
    ...
    answer: (
      <Text textAlign="start">
        ...
        gas、是否跨平台使用等)，ECN
        希望设计出链上链下具有等效性的数字凭证提供给用户。由于 VC
        的标识符兼容以太坊账户，即以太坊的公钥
